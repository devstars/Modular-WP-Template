                ...
                <div class="<?= $col_classes ?> ">
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            if (sizeof($tiles) == "3") :
                            ?>
                                <p class="usp__desc <?= $desc_class; ?>  align-h-js " data-block="<?= $block['id'] ?>"  data-align="usp-desc-<?= $group; ?>" data-align-md="usp-desc-<?= $group_md; ?>" <?= get_the_excerpt($post->ID); ?>>
                                    <?= $tile["description"] ?>
                                </p>
                            <?php
                            endif;
                            ...
                            if (sizeof($tiles) == "4") :
                            ?>
                                <p class="usp__desc <?= $desc_class; ?>  align-h-js " data-block="<?= $block['id'] ?>"  data-align="usp-desc-<?= $group; ?>" data-align-lg="usp-desc-<?= $group_lg; ?>" <?= get_the_excerpt($post->ID); ?>>
                                    <?= $tile["description"] ?>
                                </p>
                            <?php
                            endif;
